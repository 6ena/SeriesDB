...
export class SerieService {
  ...
  buscarTemporada = (imdbId: string, nroTemporada: number, config?: Partial<Rest.Config>) =>
  ...
  persistirSerie = (serieDto: SerieDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, void>({
      method: 'POST',
      url: '/api/app/serie/persistir-serie',
      body: serieDto,
    },
    { apiName: this.apiName,...config });
