...
public class SeriesDBDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SeriesDBGlobalFeatureConfigurator.Configure();
        SeriesDBModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SeriesDBDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SeriesDBResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SeriesDB");

            options.DefaultResourceType = typeof(SeriesDBResource);
        ...
        {
            options.MapCodeNamespace("SeriesDB", typeof(SeriesDBResource));
        });
    }
}
