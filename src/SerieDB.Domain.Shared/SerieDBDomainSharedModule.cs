...
public class SerieDBDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SerieDBGlobalFeatureConfigurator.Configure();
        SerieDBModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SerieDBDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SerieDBResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SerieDB");

            options.DefaultResourceType = typeof(SerieDBResource);
        ...
        {
            options.MapCodeNamespace("SerieDB", typeof(SerieDBResource));
        });
    }
}
